...
function App() {
  ...
  useEffect(() => {
    if(loaded){ 
      ...
      dispatch({ type: "SET_PREDICATE_EXPLORE_DATA", predData: data.predicates, parentToChildDict: data.parent_dict, dataTypes: data.dtypes, dataTypeRanges: data.dtype_ranges})
    }
  }, [loaded])
